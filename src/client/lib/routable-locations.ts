...
export type RoutableLocationCategory =
  | 'Border Crossing'
  | 'Park/Recreation Area Access'
  | 'Provincial Exit/Entry'

export type RoutableLocation = {
  name: string
  category: RoutableLocationCategory
  longitude: number
  latitude: number
}
...
export const ROUTABLE_LOCATIONS: RoutableLocation[] = [
  ...
  },
  {
    ...
    category: 'Park/Recreation Area Access',
    longitude: -123.1337,
    latitude: 49.7872,
  },
  {
  ...
  },
  {
    ...
    category: 'Provincial Exit/Entry',
    longitude: -116.2844,
    latitude: 51.4535,
  },
  {
