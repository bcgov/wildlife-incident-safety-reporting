...
// No focus outline on purpose: Input's outline-none neutralizes its outline utilities, so the border shift is the app's real focus style
const numberFieldGroupVariants = cva(
  "relative flex w-full justify-between border border-input data-disabled:pointer-events-none data-disabled:opacity-50 aria-invalid:border-destructive rounded-md bg-transparent dark:bg-input/30 transition-colors hover:border-border-strong has-[input:focus-visible]:border-ring",
  {
    variants: {
      size: {
        sm: "h-7 text-sm",
