			...
			<>
				...
				<Popover
					...
					<PopoverTrigger
						...
						className={cn(
							"flex p-1 rounded-md border border-input min-h-10 h-auto items-center justify-between bg-transparent text-sm shadow-xs transition-[color,box-shadow] hover:bg-muted [&_svg]:pointer-events-auto dark:bg-input/30",
										...
										{selectedValues.length > responsiveSettings.maxCount && (
											<Badge
												...
												<div
													...
													aria-label={`Remove ${selectedValues.length - responsiveSettings.maxCount} extra selected options`}
													className="ml-2 h-4 w-4 cursor-pointer hover:bg-white/20 rounded-sm p-0.5 -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50">
													<XCircle
														className={cn(
															"h-3 w-3",
